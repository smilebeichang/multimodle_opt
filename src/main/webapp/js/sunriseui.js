...
//			document.write('<script src="' + bootPATH + '/common/js/socket/sockjs-0.3.min.js" type="text/javascript"></script>');//sockjs公共js
		...
		case 'ajaxfileupload':{
			document.write('<script src="' + bootPATH + '/common/js/ajaxfileupload.js" type="text/javascript"></script>');
			break;
		}
		case 'security':{
		...
		case 'ueditor':{
            document.write('<script src="' + bootPATH + '/common/js/ueditor/ueditor.config.js" type="text/javascript"></script>');
            document.write('<script src="' + bootPATH + '/common/js/ueditor/ueditor.all.min.js" type="text/javascript"></script>');
            document.write('<script src="' + bootPATH + '/common/js/ueditor/lang/zh-cn/zh-cn.js" type="text/javascript"></script>');
            break;
        }
		case 'echarts':{
